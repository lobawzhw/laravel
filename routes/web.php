...
//Route::put('/posts', '\App\Http\Controllers\PostController@index'); // {{method_field('PUT')}}

/*Route::group(['prefix'=>'posts'], function(){
    Route::get('/', '\App\Http\Controllers\PostController@index');
    Route::post('/', '\App\Http\Controllers\PostController@index');
    Route::any('/', '\App\Http\Controllers\PostController@index');
    Route::match(['get', 'post'], '/', '\App\Http\Controllers\PostController@index');
    Route::put('/', '\App\Http\Controllers\PostController@index'); // {{method_field('PUT')}}
});*/
//用户模块
//注册页面
